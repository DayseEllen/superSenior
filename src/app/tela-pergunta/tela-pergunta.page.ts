...
export class TelaPerguntaPage implements OnInit {
  ...
  /*private async inserirPerguntas() {
   ...
   [
     ...
     { enunciado: 'Qual o nome do ícone da imagem acima?', resposta: 'Google Chrome', alternativas: [ 'Google Chrome', 'PlayStore', 'Lanterna' ], dica: 'Podemos usá-lo para fazer pesquisas na internet.', urlDaImagem: 'https://firebasestorage.googleapis.com/v0/b/super-senior.appspot.com/o/chorme.png?alt=media&token=80054560-cc27-44a0-8c08-a55d096a0afc' },
